...
func (rb *roleBuilder) buildGlobalRoles() []v3.GlobalRole {
	var result []v3.GlobalRole
...
func (rb *roleBuilder) buildRoleTemplates() []v3.RoleTemplate {
	var result []v3.RoleTemplate
	for current := rb.first(); rb != nil; rb = rb.next {
		result = append(result, v3.RoleTemplate{
			ObjectMeta: v1.ObjectMeta{
				Name:   harvesterRoleNamePrefix + current.name,
				Labels: managedLabel,
			},
